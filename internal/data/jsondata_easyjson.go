...
func easyjson668a05eDecodeYaDevops1InternalData(in *jlexer.Lexer, out *Metrics) {
...
func easyjson668a05eEncodeYaDevops1InternalData(out *jwriter.Writer, in Metrics) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Metrics) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson668a05eEncodeYaDevops1InternalData(&w, v)
...
func (v *Metrics) UnmarshalJSON(data []byte) error {
	...
	easyjson668a05eDecodeYaDevops1InternalData(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Metrics) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson668a05eDecodeYaDevops1InternalData(l, v)
}
